...
log_find_nums = open("./maddpg/maddpg_la_4_30_nums.csv", "w+")
log_ep_rew_mean = open("./maddpg/maddpg_la_4_30_rew.csv", "w+")
log_ep_len_mean = open("./maddpg/maddpg_la_4_30_len.csv", "w+")
...
class single_bu0_env(gym.Env):
    ...
    def __init__(self):
        ...
        self._max_episode_steps = 40    # 单个最大搜索是30次
        self.t = 0  # 全局执行步长
...
multi_agent[0].save("maddpg_la_4_30_actor1")
multi_agent[1].save("maddpg_la_4_30_actor2")
multi_agent[2].save("maddpg_la_4_30_actor3")
multi_agent[3].save("maddpg_la_4_30_actor4")
xietong_agent.save("maddpg_la_4_30_critic")
