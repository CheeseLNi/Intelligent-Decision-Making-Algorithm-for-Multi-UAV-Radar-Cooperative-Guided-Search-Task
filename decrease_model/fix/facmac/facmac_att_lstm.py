...
log_find_nums = open("D:/decrease_model/fix/facmac/facmac_att_fix_lstm_findnums.csv", "w+")
log_ep_rew_mean = open("D:/decrease_model/fix/facmac/facmac_att_fix_lstm_ep_rew_mean.csv", "w+")
log_ep_len_mean = open("D:/decrease_model/fix/facmac/facmac_att_fix_lstm_ep_len_mean.csv", "w+")
...
agent1 = DDPG("MlpPolicy", env=single_bu0_env(), gamma=0.98, action_noise=action_noise, policy_kwargs=policy_kwargs, learning_rate=0.0001,
            learning_starts=500, tensorboard_log="D:\\result\\2023_12_18\\facmac_AS_xietong_result", verbose=1, device=device)
...
xietong_agent = DDPG("MlpPolicy", env=xietong_env(), gamma=0.98, action_noise=action_noise, policy_kwargs=policy_kwargs, learning_rate=0.0001,
            learning_starts=500, tensorboard_log="D:\\result\\2023_12_18\\facmac_AS_xietong_result", verbose=1, device=device)  # 单个智能体只用critic网络
...
# multi_agent[0].load("facmac_att_fix_lstm_actor1_1e6.zip")
# multi_agent[1].load("facmac_att_fix_lstm_actor2_1e6.zip")
# multi_agent[2].load("facmac_att_fix_lstm_actor3_1e6.zip")
# xietong_agent.load("facmac_att_fix_lstm_critic_1e6.zip")
...
while xietong_agent.num_timesteps < total_timesteps:   # 三个智能体设置的训练步长是一样的
    ...
    if step % 1000 == 0:
        multi_agent[0].save(f"D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_actor1_{step:.1e}.zip")
        multi_agent[1].save(f"D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_actor2_{step:.1e}.zip")
        multi_agent[2].save(f"D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_actor3_{step:.1e}.zip")
        xietong_agent.save(f"D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_critic_{step:.1e}.zip")
...
multi_agent[0].save("D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_actor1")
multi_agent[1].save("D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_actor2")
multi_agent[2].save("D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_actor3")
xietong_agent.save("D:/decrease_model/saved_model/facmac/facmac_att/facmac_att_fix_lstm_critic")
