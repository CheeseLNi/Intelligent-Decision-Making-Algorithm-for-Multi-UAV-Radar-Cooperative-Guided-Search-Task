...
log_find_nums = open("D:/decrease_model/fix/facmac/facmac_fix_findnums.csv", "w+")
log_ep_rew_mean = open("D:/decrease_model/fix/facmac/facmac_fix_ep_rew_mean.csv", "w+")
log_ep_len_mean = open("D:/decrease_model/fix/facmac/facmac_fix_ep_len_mean.csv", "w+")
...
# multi_agent[0].load("facmac_fix_actor1_1e6.zip")
# multi_agent[1].load("facmac_fix_actor2_1e6.zip")
# multi_agent[2].load("facmac_fix_actor3_1e6.zip")
# xietong_agent.load("facmac_fix_critic_1e6.zip")
...
while xietong_agent.num_timesteps < total_timesteps:   # 三个智能体设置的训练步长是一样的
    ...
    if step % 1000 == 0:
        multi_agent[0].save(f"D:/decrease_model/saved_model/facmac/facmac/facmac_fix_actor1_{step:.1e}.zip")
        multi_agent[1].save(f"D:/decrease_model/saved_model/facmac/facmac/facmac_fix_actor2_{step:.1e}.zip")
        multi_agent[2].save(f"D:/decrease_model/saved_model/facmac/facmac/facmac_fix_actor3_{step:.1e}.zip")
        xietong_agent.save(f"D:/decrease_model/saved_model/facmac/facmac/facmac_fix_critic_{step:.1e}.zip")
...
multi_agent[0].save("D:/decrease_model/saved_model/facmac/facmac/facmac_fix_actor1")
multi_agent[1].save("D:/decrease_model/saved_model/facmac/facmac/facmac_fix_actor2")
multi_agent[2].save("D:/decrease_model/saved_model/facmac/facmac/facmac_fix_actor3")
xietong_agent.save("D:/decrease_model/saved_model/facmac/facmac/facmac_fix_critic")
