...
log_find_nums = open("D:/decrease_model/fix/matd3/matd3_att_fix_findnums.csv", "w+")
log_ep_rew_mean = open("D:/decrease_model/fix/matd3/matd3_att_fix_ep_rew_mean.csv", "w+")
log_ep_len_mean = open("D:/decrease_model/fix/matd3/matd3_att_fix_ep_len_mean.csv", "w+")
...
agent1 = DDPG("MlpPolicy", env=single_bu0_env(), gamma=0.98, action_noise=action_noise, policy_kwargs=policy_kwargs, learning_rate=0.0001,
            learning_starts=500, tensorboard_log="D:\\decrease_model\\result\\2025_2_27\\AS_xietong_result", verbose=1, device=device)
...
xietong_agent = MATD3Agent("MlpPolicy", env=xietong_env(), gamma=0.98, 
                          ...
                          tensorboard_log="D:\\decrease_model\\result\\2025_2_27\\AS_xietong_result", device=device)
# 在智能体初始化参数中增加
...
while xietong_agent.num_timesteps < total_timesteps:   # 三个智能体设置的训练步长是一样的
    ...
    if step % 1000 == 0:
        save_path = f"D:/decrease_model/saved_model/matd3/matd3_att/matd3_att_fix_critic_{step:.1e}.zip"
        torch.save({
        ...
        multi_agent[0].save(f"D:/decrease_model/saved_model/matd3/matd3_att/matd3_att_fix_actor1_{step:.1e}.zip")
        multi_agent[1].save(f"D:/decrease_model/saved_model/matd3/matd3_att/matd3_att_fix_actor2_{step:.1e}.zip")
        multi_agent[2].save(f"D:/decrease_model/saved_model/matd3/matd3_att/mtd3g_att_fix_actor3_{step:.1e}.zip")
...
multi_agent[0].save("D:/decrease_model/saved_model/matd3/matd3_att/matd3_att_fix_actor1")
multi_agent[1].save("D:/decrease_model/saved_model/matd3/matd3_att/matd3_att_fix_actor2")
multi_agent[2].save("D:/decrease_model/saved_model/matd3/matd3_att/matd3_att_fix_actor3")
save_path = f"D:/decrease_model/saved_model/matd3/matd3_att/matd3_att_fix_critic"
torch.save({
    "actor": xietong_agent.actor.state_dict(),
    "critic": xietong_agent.critic.state_dict(),
    "critic_optimizers": [
