...
log_find_nums = open("./maddpg/maddpg_fix_4_30_nums.csv", "w+")
log_ep_rew_mean = open("./maddpg/maddpg_fix_4_30_rew.csv", "w+")
log_ep_len_mean = open("./maddpg/maddpg_fix_4_30_len.csv", "w+")
...
multi_agent[0].save("maddpg_4_30_actor1")
multi_agent[1].save("maddpg_4_30_actor2")
multi_agent[2].save("maddpg_4_30_actor3")
multi_agent[3].save("maddpg_4_30_actor4")
xietong_agent.save("maddpg_4_30_critic")
