...
action_dim = 2
log_find_nums = open("./maddpg/ma_snf_4_30_nums.csv", "w+")
log_ep_rew_mean = open("./maddpg/ma_snf_4_30_rew.csv", "w+")
log_ep_len_mean = open("./maddpg/ma_snf_4_30_len.csv", "w+")
...
input_dataset = [input_data, input_data, input_data, input_data]
output_dataset = [output_data, output_data, output_data, output_data]
