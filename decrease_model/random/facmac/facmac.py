...
import random 
log_find_nums = open("D:/decrease_model/random/facmac/facmac_random_findnums.csv", "w+")
log_ep_rew_mean = open("D:/decrease_model/random/facmac/facmac_random_ep_rew_mean.csv", "w+")
log_ep_len_mean = open("D:/decrease_model/random/facmac/facmac_random_ep_len_mean.csv", "w+")
...
while xietong_agent.num_timesteps < total_timesteps:   # 三个智能体设置的训练步长是一样的
    ...
    if step % 1000 == 0:
        multi_agent[0].save(f"D:/decrease_model/saved_model/facmac/facmac_random/facmac_random_actor1_{step:.1e}.zip")
        multi_agent[1].save(f"D:/decrease_model/saved_model/facmac/facmac_random/facmac_random_actor2_{step:.1e}.zip")
        multi_agent[2].save(f"D:/decrease_model/saved_model/facmac/facmac_random/facmac_random__actor3_{step:.1e}.zip")
        xietong_agent.save(f"D:/decrease_model/saved_model/facmac/facmac_random/facmac_random_critic_{step:.1e}.zip")
...
multi_agent[0].save("facmac_random_actor1")
multi_agent[1].save("facmac_random_actor2")
multi_agent[2].save("facmac_random_actor3")
xietong_agent.save("facmac_random_critic")
