...
log_find_nums = open("D:/decrease_model/random/maddpg/maddpg_att_random_supervised_findnums.csv", "w+")
log_ep_rew_mean = open("D:/decrease_model/random/maddpg/maddpg_att_random_supervised_ep_rew_mean.csv", "w+")
log_ep_len_mean = open("D:/decrease_model/random/maddpg/maddpg_att_random_supervised_ep_len_mean.csv", "w+")

Agent1_actor_loss = open("D:/decrease_model/random/maddpg/Agent1_actor_loss.csv", "w+")
Agent2_actor_loss = open("D:/decrease_model/random/maddpg/Agent2_actor_loss.csv", "w+")
Agent3_actor_loss = open("D:/decrease_model/random/maddpg/Agent3_actor_loss.csv", "w+")
Agent_actor_loss = [Agent1_actor_loss, Agent2_actor_loss, Agent3_actor_loss]
Agent_critic_loss = open("D:/decrease_model/random/maddpg/Agent_critic_loss.csv", "w+")
...
while xietong_agent.num_timesteps < total_timesteps:   # 三个智能体设置的训练步长是一样的
    ...
    if step % 1000 == 0:
        multi_agent[0].save(f"D:/decrease_model/saved_model/maddpg/maddpg_att_random_supervised/maddpg_att_random_supervised_actor1_{step:.1e}.zip")
        multi_agent[1].save(f"D:/decrease_model/saved_model/maddpg/maddpg_att_random_supervised/maddpg_att_random_supervised_actor2_{step:.1e}.zip")
        multi_agent[2].save(f"D:/decrease_model/saved_model/maddpg/maddpg_att_random_supervised/maddpg_att_random_supervised_actor3_{step:.1e}.zip")
        xietong_agent.save(f"D:/decrease_model/saved_model/maddpg/maddpg_att_random_supervised/maddpg_att_random_supervised_critic_{step:.1e}.zip")
...
multi_agent[0].save("maddpg_att_random_supervised_actor1")
multi_agent[1].save("maddpg_att_random_supervised_actor2")
multi_agent[2].save("maddpg_att_random_supervised_actor3")
xietong_agent.save("maddpg_att_random_supervised_critic")
